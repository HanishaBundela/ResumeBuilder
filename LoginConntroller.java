...
public class LoginConntroller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("username check : " + uName + " checked : " + uName.equals("hanisha"));
		System.out.println("password check : " + pwd + " checked : " + pwd.equals("admin"));
		
		if(uName.equals("hanisha") && pwd.equals("admin")) {
			...
			out.println("<a href=\"/ResumeBuilder/index.jsp\">Login</a>");
